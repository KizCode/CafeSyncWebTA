...
<div class="container-fluid page-shell py-4">
    <x-page-header :title="__('ui.products_recipes')" icon="fa-mug-saucer" :badge="__('ui.role_administrator')"
        :description="__('ui.admin_products_desc')">
        <x-slot name="actions">
                    ...
                    <tbody>
                        @forelse ($products as $product)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('admin.products.edit', $product) }}" class="btn btn-outline-secondary btn-sm">{{ __('ui.edit') }}</a>
