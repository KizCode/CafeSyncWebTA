                    ...
                    <div id="receiptContent" class="border rounded p-4 mb-3">
                        ...
                        <div class="mb-3">
                            <div class="row mb-1">
                                ...
                                <div class="col-7 text-end"><small><strong>{{ $transaction->invoice_number }}</strong></small></div>
                            </div>
                            <div class="row mb-1">
                                <div class="col-5"><small>Tanggal:</small></div>
                                <div class="col-7 text-end"><small>{{ $transaction->created_at->format('d/m/Y H:i') }}</small></div>
                            </div>
                            <div class="row">
