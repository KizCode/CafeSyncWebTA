        ...
        <div class="col-lg-8 mx-auto">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3">
                    <div>
                        ...
                        <p class="text-muted mb-0">Nyalakan mode gelap untuk tampilan yang lebih nyaman di cahaya redup.</p>
                    </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="p-4 rounded-3" style="background: var(--surface-soft); border: 1px solid var(--border-color);">
                        <p class="mb-2">Tema akan diterapkan secara otomatis pada seluruh halaman aplikasi.</p>
                        <p class="text-muted">Pilihan ini disimpan di browser dan akan tetap aktif saat Anda kembali.</p>
                    </div>
                </div>
            </div>
        </div>
